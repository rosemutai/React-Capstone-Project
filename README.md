...
Go to github and find the repository React-Capstone-Project
...
```sh
  cd my-folder
  git clone git@github.com:rosemutai/React-Capstone-Project.git
```
--->
### Install
...
Example:
```sh
git@github.com:rosemutai/React-Capstone-Project.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
Feel free to check the [https://github.com/rosemutai/React-Capstone-Project/issues.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
